...
const Feedback = () => (
  <section className={`${styles.paddings} relatice z-10`}>
    <motion.div
      ...
      >
        ...
        <div>
          ...
          text-[12px] sm:leading-[22px] leading-[16px] text-white">
            Founder | MrinalsMetaverse</p>
        </div>

        <p className="mt-[24px] font-normal sm:text-[24px]
          text-[18px] sm:leading-[45px] leading-[39px] text-white">“With the development of today's
           technology, metaverse is very useful for 
           today's work, or can be called web 3.0. by
            using metaverse you can use it as anything”</p>
      </motion.div>
    ...
    className="lg:block hidden absolute -left-[10%]
    top-[3%] "
    >
      <img 
      src="/stamp.png"
